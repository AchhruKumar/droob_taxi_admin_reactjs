...
const OrdersPage = () => {
            ...
            <div
              className={
                ...
                (orderList.orderStatus === "pending"
                  ...
                  : "") +
                (orderList.orderStatus === "confirmed"
    ...
    },
    {
      ...
      render: (orderList) =>
        loading ? (
          ...
          <Select
            // Added a fallback to empty string and ensured lowercase matching
  ...
  const getAllOdersCallBack = () => {
    getAllOders(
      `${ORDERS.ALL_LIST}?page=1&limit=10&search=${debouncedSearch}&restaurantId=${user?.resturant?.id}`,
    );
  };

  const handleApplyDateFilter = () => {
    getAllOders(
      `${ORDERS.ALL_LIST}?page=1&limit=10&search=${debouncedSearch}&fromDate=${date}&toDate=${toDate}&restaurantId=${user?.resturant?.id}`,
    );
  };
